    ...
    >
      <section className="container xl:h-[100vh] pt-[15%] xl:pl-[160px]">
        ...
        <p className="text-gray-400 mt-8 max-w-[720px] text-md sm:text-xl max-sm:text-center">
          Здравствуйте, меня зовут Даниил, на данный момент активно изучаю Unity
          и создаю свои пэт проекты для портфолио. Имеется крепкий базис по
          программированию и ООП, также знаком с Unreal Engine и C++, геймдев
          меня привлекает в первую очередь возможностями развития и отличной
          интерполяцией ООП и кода в визуальный вывод. Также есть опыт работы
